...
avgTurkeyBAM <- estimate_means(TurkeyBam, by = c("zone", "season"), estimate = "average", discrete=TRUE, n.threads=2)%>%mutate(time=(nocc/2)+nocc*(season-1))#takes a while
occTurkeyBAM <- estimate_means(TurkeyBam, by = c("zone", "season", "occ"), estimate = "average", discrete=TRUE, n.threads=2)%>%mutate(time=occ+nocc*(season-1))
```
...
avgTurkeyBAMRE <- estimate_means(TurkeyBamRE, by = c("zone", "season"), estimate = "average", discrete=TRUE, n.threads=2)%>%mutate(time=(nocc/2)+nocc*(season-1))#takes a while
occTurkeyBAMRE <- estimate_means(TurkeyBamRE, by = c("zone", "season", "occ"), estimate="average", discrete=TRUE, n.threads=2)%>%mutate(time=occ+nocc*(season-1))#1410-1506
```
...
occTurkeyBAMRE <- estimate_means(TurkeyBamRE, by = c("zone", "season", "occ"))%>%mutate(time=occ+nocc*(season-1))
```
